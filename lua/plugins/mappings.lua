    ...
    opts = {
      mappings = {
        ...
        n = {
          ...
          -- ["<C-,>"] = { function() require("astrocore.buffer").nav(-(vim.v.count > 0 and vim.v.count or 1)) end, desc = "Previous buffer" },
          ["<S-D-}>"] = {
            function() require("astrocore.buffer").nav(vim.v.count > 0 and vim.v.count or 1) end,
            desc = "Next buffer",
          },
          ...
          -- ["<C-[>"] = { function() require("astrocore.buffer").prev() end, desc = "Previous buffer" },
        ...
        i = {
          ...
          ["<M-BS>"] = {
            "copilot#Dismiss()",
            desc = "Dismiss the current copilot suggestion",
            script = true,
            silent = true,
            nowait = true,
            expr = true,
